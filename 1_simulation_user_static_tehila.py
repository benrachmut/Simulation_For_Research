...
def create_random_player(map_,id_, rnd_ability):
    instead of player create medical unit from tehila
...
def create_players(i,map1):
    ans = []
    abil_list = []
    create_ability_list_from_tehila_put them in abil_list,
...
def run_simulation(i):
    ...
    max improtance is not random and will be extracted from the amount of potential casulties to save
    mission is a casulty
